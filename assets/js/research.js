...
const research = [
  {
    title: "Neural Network Based Phishing Website Classification: An Empirical Analysis",
    authors:
      "Shoaib, Bilal Khan, Muhammad Arshad and Sadia",
    conferences:
    ...
    citation: {
      vancouver:
        "Shoaib, Bilal Khan, Muhammad Arshad and Sadia. Neural Network Based Phishing Website Classification: An Empirical Analysis. Malaysian Journal of Computer Science.",
    },
    abstract:
      "In today’s age of science and technology we face a threat of hackers steeling our data. So every big organization has a cyber security team that protects the organization from cyber threats. There are different types of threats that an organization or even a common person faces. Some of the common ones are Ransomware, Phishing, Data leakage, Hacking and Insider threat. In this paper we are going to be discussing phishing websites and perform binary classification on different datasets. We are going to use various neural network algorithms and perform a performance assessment between these algorithms. Many researchers have used different ML algorithms on different phishing datasets and have produced good results in the detection of phishing attacks. But as cyber-attacks are increasing, phishers are using new tools and techniques to exploit users. And for that reason, there is a need for new and better techniques that can defend against these types of attacks. This research aims to propose a model that will be capable of correctly classifying phishing websites. The aim will be to analyze and compare the  result of two datasets on different ML algorithms. ",
    absbox: "absPopup1",
  },
  // },
  // {
